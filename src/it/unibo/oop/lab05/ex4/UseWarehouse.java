...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
        final Product p1 = new ComparableProduct("Product 2", 20);
        final Product p2 = new ComparableProduct("Product 1", 10);
        final Product p3 = new ComparableProduct("Product 3", 403);
